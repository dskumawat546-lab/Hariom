        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100 space-y-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start gap-3 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-0.5">
                    {settings.officeAddress || 'Hariom Tower, Jagatpura Road, Sector 12, Main Ring Road, Jaipur, Rajasthan 302020'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-0.5">
                    Primary: <a href={`tel:${settings.phonePrimary}`} className="font-bold text-slate-900">{settings.phonePrimary || '+91 99831 88677'}</a>
                  </p>
                  <p className="text-xs text-slate-600">
                    Secondary: <a href={`tel:${settings.phoneSecondary}`} className="font-bold text-slate-900">{settings.phoneSecondary || '+91 99831 88677'}</a>
                  </p>
                </div>
              </div>
            ...
            <div className="pt-2 flex flex-col gap-3">
              <a
                href={`https://wa.me/${settings.whatsappNumber || '919983188677'}?text=${encodeURIComponent('Hello Hariom Buildhomes, I would like to schedule a site visit.')}`}
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href={`tel:${settings.phonePrimary?.replace(/[^0-9+]/g, '') || '+919983188677'}`}
