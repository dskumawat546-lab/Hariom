        ...
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4 text-xs font-medium">
            ...
            >
              ...
              <span className="font-bold text-white">{settings.phonePrimary || '+91 99831 88677'}</span>
            </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden sm:flex items-center gap-3">
              <a
                href={`https://wa.me/${settings.whatsappNumber || '919983188677'}?text=${encodeURIComponent('Hello Hariom Buildhomes, I am interested in your residential projects.')}`}
                target="_blank"
                rel="noreferrer"
          ...
          <div className="xl:hidden bg-white border-b border-slate-200 px-4 pt-2 pb-6 space-y-2 animate-fade-in shadow-xl">
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col gap-3">
              ...
              <div className="flex gap-2">
                ...
                <a
                  href={`https://wa.me/${settings.whatsappNumber || '919983188677'}?text=${encodeURIComponent('Hello Hariom Buildhomes, I need project details.')}`}
                  target="_blank"
                  rel="noreferrer"
